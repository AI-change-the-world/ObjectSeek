...
class VideoEditor:
    ...
    def extract_and_concatenate(self, segments, transition_text="第{}个场景",
                                transition_duration=2.0, output="output.mp4"):
